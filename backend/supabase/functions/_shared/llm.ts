 ...
 * not one attempt.
 *
 * **Raised from 120s and then sized against the gateway on 2026-09-09**, after
 * the product decision that every chapter is generated by an ordinary blocking
 * request (no streaming anywhere).
 *
