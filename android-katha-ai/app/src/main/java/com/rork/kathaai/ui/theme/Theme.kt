...
object KathaTheme {
    ...
    fun coverColors(genre: Genre): List<Color> = when (genre) {
        Genre.FICTION -> listOf(Color(0xFFE89F3D), Color(0xFFC8842A), Color(0xFF8B5A2A))
        ...
        Genre.LITERARY -> listOf(Color(0xFF5A4A3A), Color(0xFF3A2D1D), Color(0xFF1A1205))
        Genre.ADVENTURE -> listOf(Color(0xFFE87B4A), Color(0xFFC04A2D), Color(0xFF8B2A1A))
        Genre.FOLKLORE -> listOf(Color(0xFFB8A03D), Color(0xFF8E7A2A), Color(0xFF5A4D1A))
