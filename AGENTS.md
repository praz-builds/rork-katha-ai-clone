...
Cover images are generated by DALL-E 3 (OpenAI API) at publish time. Full reference: `backend/COVER_IMAGES.md`. Pipeline: `_shared/image.ts` + `_shared/cover-prompts.ts`.
